            ...
            {showLabels && (
              ...
              >
                ...
                <span
                  ...
                  className="overflow-hidden text-ellipsis whitespace-nowrap font-semibold text-[clamp(1rem,1.4vw,1.4rem)] tracking-[0.01em] opacity-0 [text-shadow:0_2px_14px_rgba(0,0,0,0.55)]"
